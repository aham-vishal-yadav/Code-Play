...
function LocalIDE({ roomID, name }) {
    ...
    return (
        <>
            <div className='flex w-[100%] h-16 justify-center  text-2xl text-primary text-center items-center'
                style={{ background: "linear-gradient(to right, rgb(15, 23, 42), rgb(88, 28, 135), rgb(15, 23, 42))" }} >
                <div className='w-[100%] justify-center flex'>
                    <a className='no-underline' href='/'> Code Play</a>
                </div>
                <div className='flex'>
                ...
                <section className="playground w-[100%] md:w-1/2 h-[100%] flex-wrap">
                    <div>
                        <div className='w-[100%]  flex flex-wrap'
                            style={{ background: "linear-gradient(to right, rgb(153, 246, 228), rgb(217, 249, 157))" }}
                        >
                            {
                    ...
                    <div className='flex  h-[47px] w-[100%] justify-center'
                        style={{ background: "linear-gradient(to right, rgb(153, 246, 228), rgb(217, 249, 157))" }}
                    >
